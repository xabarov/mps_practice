...
def get_variance(moments):
    ...
    coev = math.sqrt(variance) / moments[0]
...
if __name__ == "__main__":
    ...
    if dataset_num == 1:
        wait_times = read_data("../Общие файлы/Shared_Database.csv")
    elif dataset_num == 2:
        wait_times = read_data2("../Общие файлы/attendances.csv")
    else:
        wait_times = read_data3("../Общие файлы/Uber Request Data.csv")
